...
type CasbinAdapter struct {
	...
	menuActionResourceRepository repository.IMenuActionResourceRepository
}
...
func (a *CasbinLogger) LogError(err error, msg ...string) {
	a.zap.Error(err.Error())
}
...
// NewCasbinService creates a new rbac-boilerplate
